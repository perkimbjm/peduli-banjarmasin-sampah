...
const BankSampahDetail = () => {
  ...
  const [activeLayers] = useState<string[]>(["bank-sampah"]);
  ...
  if (!bankSampah) {
    return (
      <div className="container mx-auto p-4 text-center">
        ...
        <Link to="/bank-sampah" className="text-green-600 hover:underline flex items-center justify-center mt-4">
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-green-600 to-blue-600 text-white">
        ...
        <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row gap-6 items-center">
          <Avatar className="h-24 w-24 md:h-32 md:w-32 rounded-xl bg-white p-1">
            ...
            <AvatarFallback className="text-3xl font-bold text-green-600">{bankSampah.name.charAt(0)}</AvatarFallback>
          </Avatar>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="font-semibold">{bankSampah.wasteCollected.toLocaleString()} kg</p>
                        </div>
                      </div>
                      <div className="flex items-center">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {bankSampah.instagram && (
                <div className="flex items-center">
                  <Instagram className="h-5 w-5 mr-3 text-green-600" />
                  <div>
                    <p className="text-sm text-muted-foreground">Instagram</p>
                    <p className="font-semibold">{bankSampah.instagram}</p>
                  </div>
                </div>
              )}
              <div className="flex items-center">
